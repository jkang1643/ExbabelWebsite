...
export default function LegalSection() {
  ...
  return (
    <section
      id="legal-section"
      className="mobile-fade-up bg-slate-50 border-t border-slate-200"
    >
      <div className="mobile-fade-up max-w-5xl mx-auto px-6 py-16 md:py-24">
        {/* Section eyebrow */}
        <motion.div
          initial={{ y: 20 }}
          whileInView={{ y: 0 }}
          ...
          className="mobile-fade-up text-center mb-12"
        >
          <p className="mobile-fade-up text-xs tracking-wider text-primary uppercase font-bold mb-3">
            Legal
          </p>
          <h2 className="mobile-fade-up text-2xl md:text-3xl font-bold text-slate-800">
            Privacy &amp; Terms
          </h2>
          <p className="mobile-fade-up text-sm text-slate-500 mt-2 max-w-lg mx-auto">
        ...
        <div className="mobile-fade-up space-y-4">
          ...
          <motion.div
            ...
            className="mobile-fade-up bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden"
          >
            <button
              onClick={() => toggleSection("privacy")}
              className="mobile-fade-up w-full flex items-center justify-between px-6 py-5 text-left hover:bg-slate-50 transition-colors group"
              aria-expanded={expanded === "privacy"}
            >
              <div className="mobile-fade-up flex items-center gap-3">
                <span className="mobile-fade-up w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center flex-shrink-0">
                  <svg xmlns="http://www.w3.org/2000/svg" className="mobile-fade-up w-4 h-4 text-primary" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <rect width="18" height="18" x="3" y="3" rx="2" />
                    <path d="M12 8v8" />
                    <path d="M8 12h8" />
                  </svg>
                </span>
                <span className="mobile-fade-up font-semibold text-slate-800">Privacy Policy</span>
              </div>
              <motion.svg
                animate={{ rotate: expanded === "privacy" ? 180 : 0 }}
                transition={{ duration: 0.3 }}
                xmlns="http://www.w3.org/2000/svg"
                className="mobile-fade-up w-5 h-5 text-slate-400 group-hover:text-primary transition-colors"
                viewBox="0 0 24 24"
                fill="none"
                stroke="currentColor"
                strokeWidth="2"
            ...
            <AnimatePresence initial={false}>
              {expanded === "privacy" && (
                <motion.div
                  ...
                  className="mobile-fade-up overflow-hidden"
                >
                  <div className="mobile-fade-up px-6 pb-6 text-sm text-slate-600 leading-relaxed space-y-4 border-t border-slate-100 pt-4">
                    ...
                    <h4 className="mobile-fade-up font-semibold text-slate-800 pt-2">1. Information We Collect</h4>
                    <p>
                    ...
                    <h4 className="mobile-fade-up font-semibold text-slate-800 pt-2">2. How We Use Your Information</h4>
                    <ul className="mobile-fade-up list-disc list-inside space-y-1 pl-2">
                    ...
                    <h4 className="mobile-fade-up font-semibold text-slate-800 pt-2">3. Cookies &amp; Tracking Technologies</h4>
                    <p>
                    ...
                    <h4 className="mobile-fade-up font-semibold text-slate-800 pt-2">4. Data Sharing &amp; Disclosure</h4>
                    <p>
                    ...
                    <h4 className="mobile-fade-up font-semibold text-slate-800 pt-2">5. Data Retention &amp; Security</h4>
                    <p>
                    ...
                    <h4 className="mobile-fade-up font-semibold text-slate-800 pt-2">6. Your Rights</h4>
                    <p>
                      Depending on your jurisdiction, you may have the right to access, correct, delete, or export your personal data. To exercise these rights, please contact us at <a href="mailto:support@exbabel.com" className="mobile-fade-up text-primary hover:underline">support@exbabel.com</a>.
                    </p>

                    <h4 className="mobile-fade-up font-semibold text-slate-800 pt-2">7. Contact Us</h4>
                    <p>
                      If you have questions about this Privacy Policy, please contact us at <a href="mailto:support@exbabel.com" className="mobile-fade-up text-primary hover:underline">support@exbabel.com</a>.
                    </p>
                  </div>
                </motion.div>
              )}
          ...
          >
            ...
            >
              <div className="mobile-fade-up flex items-center gap-3">
                ...
                <span className="mobile-fade-up font-semibold text-slate-800">Terms of Service</span>
              </div>
              <motion.svg
              ...
              {expanded === "terms" && (
                ...
                >
                  <div className="mobile-fade-up px-6 pb-6 text-sm text-slate-600 leading-relaxed space-y-4 border-t border-slate-100 pt-4">
                    ...
                    <h4 className="mobile-fade-up font-semibold text-slate-800 pt-2">1. Services</h4>
                    <p>
                    ...
                    <h4 className="mobile-fade-up font-semibold text-slate-800 pt-2">2. Account Registration</h4>
                    <p>
                    ...
                    <h4 className="mobile-fade-up font-semibold text-slate-800 pt-2">3. Acceptable Use</h4>
                    ...
                    <h4 className="mobile-fade-up font-semibold text-slate-800 pt-2">4. Subscription &amp; Billing</h4>
                    <p>
                    ...
                    <h4 className="mobile-fade-up font-semibold text-slate-800 pt-2">5. Intellectual Property</h4>
                    <p>
                    ...
                    <h4 className="mobile-fade-up font-semibold text-slate-800 pt-2">6. Limitation of Liability</h4>
                    <p>
                    ...
                    <h4 className="mobile-fade-up font-semibold text-slate-800 pt-2">7. Termination</h4>
                    <p>
                    ...
                    <h4 className="mobile-fade-up font-semibold text-slate-800 pt-2">8. Governing Law</h4>
                    <p>
                    ...
                    <h4 className="mobile-fade-up font-semibold text-slate-800 pt-2">9. Contact Us</h4>
                    <p>
                      For any questions regarding these Terms, please contact us at <a href="mailto:support@exbabel.com" className="mobile-fade-up text-primary hover:underline">support@exbabel.com</a>.
                    </p>
                  </div>
                </motion.div>
              )}
