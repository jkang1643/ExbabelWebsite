            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="max-w-5xl mx-auto">
                    ...
                    >
                        ...
                        <div className="absolute bottom-6 right-6 bg-black/50 md:backdrop-blur-md text-white p-3 rounded-full transition-all duration-300 group-hover:bg-black/70 hover:scale-110">
                            {isMuted ? (
