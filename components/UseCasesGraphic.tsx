...
export default function UseCasesGraphic() {
  const useCases = [
    {
      ...
      icon: (
        <svg className="mobile-fade-up w-12 h-12 text-slate-800" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  return (
    <section className="mobile-fade-up py-16 md:py-24 bg-slate-50 relative overflow-hidden">
      <div className="mobile-fade-up layout-spine max-w-6xl mx-auto px-4">
        ...
        {/* 6 Grid Cards */}
        <div className="mobile-fade-up grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {useCases.map((item, index) => (
            ...
            >
              {item.icon && <div className="mobile-fade-up mb-6 flex justify-center">{item.icon}</div>}
              <h3
