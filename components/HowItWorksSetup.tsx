...
export default function HowItWorksSetup() {
  ...
  const sources = {
    mic: {
      ...
      diagram: (
        <div className="mobile-fade-up bg-slate-900 text-white rounded-2xl p-6 border border-slate-800 space-y-4">
          <div className="mobile-fade-up flex items-center justify-between text-xs text-slate-400">
            <span>INPUT: Built-in / USB Microphone</span>
            <span className="mobile-fade-up text-emerald-400 font-bold">● ACTIVE</span>
          </div>
          <div className="mobile-fade-up p-4 bg-slate-800/80 rounded-xl border border-slate-700 font-mono text-sm text-slate-200">
            [Mic Line-In] &rarr; Exbabel Web App &rarr; Real-Time AI Stream
          </div>
          <div className="mobile-fade-up flex items-center gap-2 text-xs text-slate-400">
            <span className="mobile-fade-up w-2 h-2 rounded-full bg-blue-400" />
    ...
    obs: {
      ...
      diagram: (
        <div className="mobile-fade-up bg-slate-900 text-white rounded-2xl p-6 border border-slate-800 space-y-4">
          ...
          <div className="mobile-fade-up flex items-center gap-2 text-xs text-slate-400">
            <span className="mobile-fade-up w-2 h-2 rounded-full bg-purple-400" />
    ...
    <section className="mobile-fade-up py-20 bg-white relative overflow-hidden">
      <div className="mobile-fade-up layout-spine max-w-6xl mx-auto px-4">
        ...
        <div className="mobile-fade-up text-center mb-16 max-w-3xl mx-auto">
          <span className="mobile-fade-up text-xs font-black uppercase text-primary tracking-widest block mb-2">Phase 1 — Ingest &amp; Configuration</span>
          <h2
          ...
          <p className="mobile-fade-up text-base md:text-lg text-slate-600 font-medium">
            Exbabel works with your existing hardware and software setup in under 60 seconds — no proprietary hardware required.
          </p>
        </div>

        {/* Source Selector Tabs */}
        <div className="mobile-fade-up flex flex-wrap items-center justify-center gap-3 mb-10">
        ...
        {/* Tab Content Card */}
        <div className="mobile-fade-up bg-slate-50 border border-slate-200 rounded-3xl p-8 md:p-12 shadow-xl mb-16">
          <AnimatePresence mode="wait">
            ...
            >
              <div className="mobile-fade-up lg:col-span-6 space-y-4">
                <span className="mobile-fade-up inline-block px-3 py-1 bg-primary/10 text-primary text-xs font-bold rounded-full">
                  {sources[activeTab].badge}
                </span>
                <h3 className="mobile-fade-up text-2xl md:text-3xl font-bold text-slate-900" style={{ fontFamily: "var(--font-sora), sans-serif" }}>
                  {sources[activeTab].title}
                </h3>
                <p className="mobile-fade-up text-slate-600 leading-relaxed text-base font-medium">
                  {sources[activeTab].desc}
                </p>
              </div>
              <div className="mobile-fade-up lg:col-span-6">
        ...
        <div className="mobile-fade-up grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="mobile-fade-up bg-gradient-to-br from-slate-900 to-slate-800 text-white rounded-3xl p-8 shadow-xl relative overflow-hidden">
            <div className="mobile-fade-up w-10 h-10 rounded-2xl bg-primary/20 flex items-center justify-center text-primary font-bold mb-4 text-lg">
              📚
            </div>
            <h3 className="mobile-fade-up text-xl font-bold mb-3" style={{ fontFamily: "var(--font-sora), sans-serif" }}>
              Custom Jargon &amp; Glossaries
            </h3>
            <p className="mobile-fade-up text-slate-300 text-sm leading-relaxed mb-6 font-medium">
            ...
            <div className="mobile-fade-up bg-slate-800/80 rounded-xl p-3 text-xs font-mono text-slate-300 border border-slate-700 flex flex-wrap gap-2">
              <span className="mobile-fade-up bg-primary/20 text-blue-300 px-2 py-1 rounded">Sermon &rarr; Predicación</span>
              <span className="mobile-fade-up bg-purple-500/20 text-purple-300 px-2 py-1 rounded">Exbabel &rarr; Exbabel</span>
              <span className="mobile-fade-up bg-emerald-500/20 text-emerald-300 px-2 py-1 rounded">Fellowship &rarr; Comunión</span>
            </div>
          </div>

          <div className="mobile-fade-up bg-gradient-to-br from-slate-900 to-slate-800 text-white rounded-3xl p-8 shadow-xl relative overflow-hidden">
            <div className="mobile-fade-up w-10 h-10 rounded-2xl bg-purple-500/20 flex items-center justify-center text-purple-400 font-bold mb-4 text-lg">
              🎙️
            </div>
            <h3 className="mobile-fade-up text-xl font-bold mb-3" style={{ fontFamily: "var(--font-sora), sans-serif" }}>
            ...
            <div className="mobile-fade-up bg-slate-800/80 rounded-xl p-3 text-xs font-mono text-slate-300 border border-slate-700 flex justify-between items-center">
              <span>Selected Voice: &quot;Mateo (Spanish Warm Expressive)&quot;</span>
              <span className="mobile-fade-up text-emerald-400 font-bold">Selected ✓</span>
            </div>
          </div>
        </div>
      </div>
