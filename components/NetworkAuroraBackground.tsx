...
export default function NetworkAuroraBackground() {
  return (
    <div className="mobile-fade-up absolute inset-0 overflow-hidden pointer-events-none z-0">
      {/* Soft Ambient Glows */}
      <div className="mobile-fade-up absolute top-[-10%] left-[-10%] w-[50vw] h-[50vw] bg-[#D6F5FF] rounded-full mix-blend-multiply filter blur-[140px] opacity-60 pointer-events-none hidden lg:block" />
      <div className="mobile-fade-up absolute bottom-[-10%] right-[-10%] w-[50vw] h-[50vw] bg-[#EAD6FF] rounded-full mix-blend-multiply filter blur-[160px] opacity-50 pointer-events-none hidden lg:block" />
      <div className="mobile-fade-up absolute top-[20%] right-[10%] w-[30vw] h-[30vw] bg-[#E0F7FA] rounded-full mix-blend-multiply filter blur-[120px] opacity-40 pointer-events-none hidden lg:block" />

      {/* Network Orbits & Nodes SVG */}
      <svg className="mobile-fade-up absolute w-full h-full opacity-80" preserveAspectRatio="none" viewBox="0 0 100 100">
        <defs>
      ...
      <motion.div
        className="mobile-fade-up absolute w-40 h-40 rounded-full hidden md:block top-[25%] left-[8%]"
        style={{
      ...
      />
      <motion.div
        className="mobile-fade-up absolute w-20 h-20 rounded-full hidden md:block bottom-[25%] left-[18%]"
        style={{
      ...
      <motion.div
        className="mobile-fade-up absolute w-28 h-28 rounded-full hidden md:block top-[40%] right-[10%]"
        style={{
      ...
      <div 
        className="mobile-fade-up absolute inset-0 z-0 opacity-[0.06] pointer-events-none" 
        style={{ 
