...
export default function SupportedPlatformsSection() {
  ...
  return (
    <section className="py-24 px-6 relative z-10 bg-white overflow-hidden">
      ...
      <motion.div className="max-w-5xl mx-auto" initial="initial" whileInView="whileInView" viewport={{ once: true, margin: typeof window !== 'undefined' && window.innerWidth < 768 ? "100px" : "-100px" }} variants={staggerContainer}>
