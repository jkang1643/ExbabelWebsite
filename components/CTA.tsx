...
export default function CTA() {
  return (
    <section className="py-32 relative overflow-hidden bg-[#FAFBFF] text-base-ink">
      ...
      <div className="max-w-[1200px] mx-auto px-6 md:px-12 relative z-10 text-center space-y-10">
        ...
        <div className="inline-flex flex-wrap items-center justify-center gap-3">
          <span className="text-xs font-semibold px-3.5 py-1.5 rounded-full bg-white text-slate-700 border border-slate-200 shadow-sm tracking-wide uppercase">
            Production Ready
          </span>
          <span className="text-xs font-semibold px-3.5 py-1.5 rounded-full bg-blue-50 text-[#394dfe] border border-[#394dfe]/30 shadow-sm tracking-wide">
        ...
        <div className="flex flex-wrap justify-center gap-4 pt-2">
          ...
          <Link
            href="/lab-test"
            className="px-10 py-4 bg-white/10 hover:bg-white/20 border border-white/20 text-base-ink text-lg font-bold rounded-full transition-all hover:scale-[1.02]"
            style={{ fontFamily: 'var(--font-sora), sans-serif' }}
          >
        ...
        <div className="flex flex-wrap justify-center gap-8 pt-4 text-sm font-bold text-slate-600">
          {[
        ...
        <div className="w-full max-w-4xl mx-auto pt-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 py-10 px-6 rounded-3xl bg-white/80 md:backdrop-blur-md border border-slate-200 shadow-xl shadow-2xl relative overflow-hidden">
            ...
            <div className="relative z-10 space-y-1 md:border-x border-slate-200">
              <div className="text-4xl md:text-5xl font-black text-[#394dfe] font-mono">2.027s</div>
              <div className="text-[11px] font-semibold text-slate-500 uppercase tracking-widest">Time to First Speech</div>
            </div>

            <div className="relative z-10 space-y-1">
              <div className="text-4xl md:text-5xl font-black text-emerald-400 font-mono">10.2×</div>
              <div className="text-[11px] font-semibold text-slate-500 uppercase tracking-widest">Continuous Speed Advantage</div>
            </div>
          </div>
        </div>
