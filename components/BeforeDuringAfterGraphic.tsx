          ...
          >
            <div>
              ...
              <div className="relative w-48 h-48 mx-auto mb-8">
                ...
                {/* Floating UI Badge */}
                <div className="absolute -right-2 top-10 bg-white/95 md:backdrop-blur-md rounded-2xl p-3 shadow-lg border border-slate-100 w-44">
          ...
          >
            <div>
              ...
              <div className="relative w-48 h-48 mx-auto mb-8">
                ...
                {/* Floating UI Badge */}
                <div className="absolute -right-2 top-8 bg-white/95 md:backdrop-blur-md rounded-2xl p-3 shadow-lg border border-slate-100 w-44">
