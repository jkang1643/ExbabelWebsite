  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div
          className="absolute -top-16 -right-16 w-64 sm:w-80 h-64 sm:h-80 rounded-full opacity-30 blur-3xl transition-transform duration-700 group-hover/thumbnail:scale-110"
        ...
        <div className="absolute -right-6 top-8 font-black text-6xl sm:text-7xl lg:text-8xl tracking-tighter text-white/[0.03] select-none pointer-events-none">
      ...
      <div className="relative z-10 w-full h-full flex items-center justify-center">
        {archetype === "editorial-ui-collage" && (
          <div className="relative w-full h-full flex items-center justify-between">
            ...
            <div className="relative w-full h-full rounded-xl sm:rounded-2xl overflow-hidden shadow-2xl border border-white/10 group-hover/thumbnail:scale-[1.02] transition-transform duration-500">
              <img
                src={featuredImage}
            ...
            >
              <div className="flex items-center gap-2 sm:gap-3">
                <div className="flex items-center gap-1.5">
                  <span className="w-5 h-5 rounded-md bg-white/10 text-white font-mono text-[10px] font-bold flex items-center justify-center">
                    {editorialPill.sourceLang || "ES"}
                  </span>
                  <span className="text-white/90 text-xs font-semibold tracking-tight">
                ...
                <div className="flex items-center gap-1.5">
                  <span className="w-5 h-5 rounded-md bg-sky-500/20 text-sky-300 font-mono text-[10px] font-bold flex items-center justify-center border border-sky-400/30">
          ...
          <div className="relative w-full h-full flex items-center justify-between">
            ...
            <div className="relative w-full h-full rounded-xl sm:rounded-2xl overflow-hidden shadow-2xl border border-white/10 group-hover/thumbnail:scale-[1.02] transition-transform duration-500">
              <img
                src={featuredImage}
                alt={featuredImageAlt}
                className="w-full h-full object-cover object-center filter brightness-[0.93] contrast-[1.05]"
                loading="lazy"
              />
              <div className="absolute inset-0 bg-gradient-to-tr from-purple-950/70 via-black/30 to-transparent" />
            </div>
            ...
            >
              <div className="flex items-center gap-2 sm:gap-3 flex-wrap sm:flex-nowrap">
                ...
                <div className="flex items-center gap-1 text-[11px] font-mono text-white/90">
                  <span>Audio</span>
        ...
        {archetype === "typography-3d" && (
          <div className="relative w-full h-full rounded-xl sm:rounded-2xl overflow-hidden border border-white/10 p-6 flex flex-col justify-between">
            <div className="relative z-10">
              <span className="text-xs font-mono font-bold text-yellow-400 tracking-widest uppercase">
                EXBABEL CORE
              </span>
              <h4 className="text-3xl sm:text-4xl font-black text-white tracking-tight mt-1">
                SPEECH · VOICE · LIVE
              </h4>
            </div>
            <div className="relative z-10 flex gap-2">
              <span className="px-3 py-1 rounded-full bg-white/10 border border-white/20 text-xs text-white font-mono">
                ES → EN
              </span>
              <span className="px-3 py-1 rounded-full bg-white/10 border border-white/20 text-xs text-white font-mono">
                FR → EN
        ...
        {archetype === "brand-board" && (
          <div className="relative w-full h-full rounded-xl sm:rounded-2xl overflow-hidden border border-white/10 p-6 flex flex-col justify-between">
            <div className="w-full h-24 rounded-lg bg-black/40 border border-white/10 flex items-center justify-center">
              <span className="font-mono text-xs text-slate-300">Architecture Diagram</span>
            </div>
        ...
        {archetype === "website-mockup" && (
          <div className="relative w-full h-full rounded-xl sm:rounded-2xl overflow-hidden border border-white/10 p-4 bg-slate-950 flex flex-col">
            <div className="flex items-center gap-1.5 pb-3 border-b border-white/10">
              <div className="w-2.5 h-2.5 rounded-full bg-red-500/80" />
              <div className="w-2.5 h-2.5 rounded-full bg-yellow-500/80" />
              <div className="w-2.5 h-2.5 rounded-full bg-green-500/80" />
              <span className="ml-2 font-mono text-[10px] text-white/40">app.exbabel.com/live</span>
            </div>
            <div className="flex-1 flex items-center justify-center">
              <span className="text-white/60 text-xs font-medium">Exbabel Live Stream Canvas</span>
            </div>
          </div>
        )}
      </div>
