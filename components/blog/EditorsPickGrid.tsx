...
export default function EditorsPickGrid({ posts }: EditorsPickGridProps) {
  // Visual cards representing Editor's Pick
  return (
    <section className="w-full py-14 sm:py-20 lg:py-24 border-t border-slate-100">
      <div className="max-w-[1440px] mx-auto px-6 sm:px-10 lg:px-12">
        ...
        {/* 3 Curated Cards with Distinct Editorial Art Direction */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-10 lg:gap-12">
          
          {/* Pick 1: Purple 3D Object & Speech-to-Speech Engine */}
          <article className="group flex flex-col">
            <Link
              href="/blog/on-demand-interpretation-services"
              className="relative rounded-[22px] sm:rounded-[28px] overflow-hidden aspect-[1.62/1] bg-gradient-to-tr from-[#2E1065] via-[#581C87] to-[#7E22CE] p-6 flex flex-col justify-between group-hover:scale-[1.025] transition-transform duration-500 ease-out shadow-sm"
            >
              ...
              {/* 3D Floating Pill */}
              <div className="self-center my-auto bg-white/95 backdrop-blur-md px-5 py-2.5 rounded-full shadow-lg flex items-center gap-3">
            ...
            <div className="pt-4 flex flex-col">
              ...
              <Link href="/blog/on-demand-interpretation-services" className="group-hover:text-blue-600 transition-colors">
          ...
          {/* Pick 2: Church Sanctuary Architecture & Mobile Listener UI */}
          <article className="group flex flex-col">
            <Link
              href="/blog/church-translation-system"
              className="relative rounded-[22px] sm:rounded-[28px] overflow-hidden aspect-[1.62/1] bg-gradient-to-tr from-slate-900 via-slate-800 to-indigo-950 p-6 flex flex-col justify-between group-hover:scale-[1.025] transition-transform duration-500 ease-out shadow-sm"
            >
              <div className="flex items-center justify-between">
            ...
            <div className="pt-4 flex flex-col">
              ...
              <Link href="/blog/church-translation-system" className="group-hover:text-blue-600 transition-colors">
                <h3 className="text-xl sm:text-2xl font-bold text-slate-900 tracking-tight leading-snug">
          ...
          {/* Pick 3: Warm Terracotta Benchmark & Acoustic Quality */}
          <article className="group flex flex-col">
            <Link
              href="/lab-test"
              className="relative rounded-[22px] sm:rounded-[28px] overflow-hidden aspect-[1.62/1] bg-gradient-to-tr from-[#EA580C] via-[#F97316] to-[#FB923C] p-6 flex flex-col justify-between group-hover:scale-[1.025] transition-transform duration-500 ease-out shadow-sm"
            >
              <div className="flex items-center justify-between">
                <span className="px-3 py-1 rounded-full bg-white/20 backdrop-blur-md text-white text-[11px] font-semibold tracking-wider uppercase">
                  Benchmark
              ...
              <div className="self-center my-auto bg-slate-950 text-white px-5 py-2.5 rounded-full shadow-lg flex items-center gap-3">
            ...
            <div className="pt-4 flex flex-col">
              ...
              <Link href="/lab-test" className="group-hover:text-blue-600 transition-colors">
                <h3 className="text-xl sm:text-2xl font-bold text-slate-900 tracking-tight leading-snug">
