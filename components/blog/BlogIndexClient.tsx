...
export default function BlogIndexClient({ posts }: BlogIndexClientProps) {
  ...
  return (
    <div className="w-full">
      ...
      <section className="pt-28 pb-10 px-4 sm:px-6 lg:px-8 border-b border-slate-200/80 bg-gradient-to-b from-slate-50/60 to-white">
        <div className="max-w-6xl mx-auto">
          {/* Top metadata ticker */}
          <div className="flex flex-wrap items-center justify-between gap-4 pb-6 border-b border-slate-200/60 text-xs font-mono">
            <div className="flex items-center gap-3">
              <span className="inline-flex items-center px-2 py-0.5 rounded bg-slate-900 text-white font-bold tracking-wider text-[10px] uppercase">
                EXBABEL EDITORIAL
              </span>
              <span className="text-slate-400">|</span>
              <span className="text-slate-600 font-medium">RESEARCH & GUIDES</span>
            </div>
            <div className="flex items-center gap-2 text-slate-500">
              <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse" />
              <span className="font-semibold text-slate-700">1.013s Caption</span>
              <span className="text-slate-300">·</span>
              <span className="font-semibold text-slate-700">2.027s Speech</span>
              <span className="text-slate-300">·</span>
              <span className="text-slate-600">180+ Languages</span>
            </div>
          </div>
          ...
          <div className="pt-8 pb-6">
            <h1
              className="text-4xl sm:text-5xl lg:text-6xl font-black text-slate-950 tracking-tight leading-none mb-4"
      ...
      <section className="py-12 sm:py-16 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
        {featuredPost && (
          <div className="mb-16">
            ...
            <article className="group bg-white border border-slate-200/80 rounded-3xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300">
              <Link
                href={`/blog/${featuredPost.slug}`}
                className="grid grid-cols-1 lg:grid-cols-12 gap-0"
              >
                {/* Visual Thumbnail (Archetype 1 / Editorial Tech Collage) */}
                <div className="lg:col-span-7 p-3 sm:p-4 bg-slate-900/5">
                ...
                <div className="lg:col-span-5 p-6 sm:p-8 lg:p-10 flex flex-col justify-between">
                  <div>
                    ...
                    <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight leading-snug group-hover:text-primary transition-colors mb-4">
                      {featuredPost.title}
                    </h2>
                  ...
                  <div className="pt-6 border-t border-slate-100 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-full bg-slate-900 text-white text-xs font-black flex items-center justify-center font-mono">
                        EX
                      </div>
                      <div>
                        <div className="text-xs font-bold text-slate-900">{featuredPost.author}</div>
                        <div className="text-[10px] text-slate-500 font-mono">Verified Analysis</div>
                      </div>
                    </div>
          ...
          <div className="mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {remainingPosts.map((post) => (
                <article
                  key={post.slug}
                  className="group bg-white border border-slate-200/80 rounded-3xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col"
                >
                  <Link href={`/blog/${post.slug}`} className="flex-1 flex flex-col">
                    ...
                    <div className="p-6 sm:p-8 flex-1 flex flex-col justify-between">
                      <div>
                        ...
                        <h3 className="text-xl sm:text-2xl font-bold text-slate-900 group-hover:text-primary transition-colors leading-snug mb-3">
                          {post.title}
                        </h3>
        ...
        <section className="mb-20 bg-slate-950 text-white rounded-3xl p-6 sm:p-10 lg:p-12 relative overflow-hidden border border-slate-800 shadow-2xl">
          ...
          <div className="relative z-10">
            <div className="flex flex-wrap items-center justify-between gap-4 mb-8 pb-6 border-b border-white/10">
              ...
              <div className="text-xs font-mono text-slate-400 bg-white/5 border border-white/10 px-3 py-1.5 rounded-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
              <div className="p-6 rounded-2xl bg-white/[0.03] border border-white/10">
                <div className="text-3xl sm:text-4xl font-black font-mono text-sky-400 mb-2">
                  1.013s
                </div>
                <h4 className="text-sm font-bold text-white mb-2">Real-Time Caption Latency</h4>
              ...
              <div className="p-6 rounded-2xl bg-white/[0.03] border border-white/10">
                <div className="text-3xl sm:text-4xl font-black font-mono text-purple-400 mb-2">
                  2.027s
                </div>
                <h4 className="text-sm font-bold text-white mb-2">Speech-to-Speech Latency</h4>
                <p className="text-xs text-slate-400 leading-relaxed">
              ...
              <div className="p-6 rounded-2xl bg-white/[0.03] border border-white/10">
                <div className="text-3xl sm:text-4xl font-black font-mono text-emerald-400 mb-2">
                  Zero
                </div>
                <h4 className="text-sm font-bold text-white mb-2">Permanent Audio Retention</h4>
                <p className="text-xs text-slate-400 leading-relaxed">
        ...
        <section className="rounded-3xl border border-slate-200 bg-gradient-to-br from-slate-50 via-white to-sky-50/30 p-8 sm:p-12 text-center relative overflow-hidden shadow-sm">
          <div className="max-w-2xl mx-auto">
            <span className="inline-block text-xs font-mono font-bold tracking-widest text-primary uppercase mb-3">
              Deploy Exbabel Live
            </span>
            ...
            <div className="flex flex-wrap items-center justify-center gap-4">
              ...
              <Link
                href="/demo"
                className="px-6 py-3 rounded-full bg-white hover:bg-slate-100 text-slate-800 font-bold text-sm border border-slate-300 transition-all duration-200"
              >
