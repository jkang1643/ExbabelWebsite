...
path = '/home/jkang1643/projects/exbabel/components/DarkHeroAuroraBackground.tsx'
...
if 'import DarkHeroAuroraBackground' not in cta_content:
    cta_content = cta_content.replace('import Link from "next/link";', 'import Link from "next/link";\nimport DarkHeroAuroraBackground from "./DarkHeroAuroraBackground";')

old_bg = '''      {/* Aurora Glow Overlays */}
...
new_bg = '''      <DarkHeroAuroraBackground />'''

cta_content = cta_content.replace(old_bg, new_bg)

with open(cta_path, 'w', encoding='utf-8') as f:
    f.write(cta_content)

print("Applied DarkHeroAuroraBackground")